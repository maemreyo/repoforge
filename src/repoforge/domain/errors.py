...
class ErrorCode(str, Enum):
    ...
    OPERATION_REPAIR_BLOCKED = "OPERATION_REPAIR_BLOCKED"
    OPERATION_REPAIR_STALE = "OPERATION_REPAIR_STALE"
    ...
    GIT_TRANSPORT_KEY_UNSAFE = "GIT_TRANSPORT_KEY_UNSAFE"
    GIT_TRANSPORT_KEY_MISMATCH = "GIT_TRANSPORT_KEY_MISMATCH"
    GIT_TRANSPORT_PRINCIPAL_MISMATCH = "GIT_TRANSPORT_PRINCIPAL_MISMATCH"
    GIT_TRANSPORT_ENDPOINT_STALE = "GIT_TRANSPORT_ENDPOINT_STALE"
    GIT_TRANSPORT_MIGRATION_REQUIRED = "GIT_TRANSPORT_MIGRATION_REQUIRED"
