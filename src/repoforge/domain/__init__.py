...
_EXPORTS = {
    ...
    "AuthProfileSelector": ("auth_profile", "AuthProfileSelector"),
    "AuthSelectionRequest": ("auth_profile", "AuthSelectionRequest"),
    ...
    "RequestedActorClass": ("auth_profile", "RequestedActorClass"),
    "ReviewedPublication": ("publication", "ReviewedPublication"),
    "NestedAccess": ("nested_identity", "NestedAccess"),
    "NestedBindingState": ("nested_identity", "NestedBindingState"),
    "NestedIdentityReceipt": ("nested_identity", "NestedIdentityReceipt"),
    "NestedResourceCandidate": ("nested_identity", "NestedResourceCandidate"),
    "NestedResourceKind": ("nested_identity", "NestedResourceKind"),
    "NestedResourceTarget": ("nested_identity", "NestedResourceTarget"),
    "NestedRoutingDecision": ("nested_identity", "NestedRoutingDecision"),
    "NestedRoutingStatus": ("nested_identity", "NestedRoutingStatus"),
    "NestedPublicationIntent": ("nested_publication", "NestedPublicationIntent"),
    "ReviewedNestedPublication": ("nested_publication", "ReviewedNestedPublication"),
    "RepositoryIdentityBinding": ("repository_identity", "RepositoryIdentityBinding"),
    "canonical_nested_endpoint": ("nested_identity", "canonical_nested_endpoint"),
    "nested_endpoint_digest": ("nested_identity", "nested_endpoint_digest"),
    "route_nested_resource": ("nested_identity", "route_nested_resource"),
    "revalidate_nested_publication": (
        "nested_publication",
        "revalidate_nested_publication",
    ),
    "review_nested_publication": ("nested_publication", "review_nested_publication"),
    "resolve_auth_profile": ("auth_profile", "resolve_auth_profile"),
